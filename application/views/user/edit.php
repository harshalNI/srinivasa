            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="<?php echo base_url('users/edit/'.$details->user_id);?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-6">
                                        <a href="<?php echo base_url('users');?>"><input type="button" name="Cancel" value="Cancel" class="btn btn-sm btn-default"></a>
