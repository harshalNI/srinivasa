<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <a href="<?php echo base_url('branch/users/add');?>"><button class="btn btn-outline btn-info  dim active" type="button">Add New User</button></a>
                </div>
                <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="<?php echo base_url('branch/users/edit/'.$details->user_id);?>" enctype="multipart/form-data">
                                <div class="form-group"><label class="col-lg-2 control-label">Branch Name</label>
                                    <div class="col-lg-6">
                                        <?php if(form_error('branchName') != ''){?>
                                        <div class="form-group has-error">
                                        <?php }?>
                                            <select required="" name="branchName" class="chosen-select form-control">
                                                <option value="">Select Customer</option>
                                                <?php foreach($branches as $branch):?>
                                                    <option <?php if($details->user_branch_id == $branch->branch_id){?> selected <?php }?> value="<?php echo $branch->branch_id;?>"><?php echo $branch->branch_name;?></option>
                                                <?php endforeach;?>
                                            </select> 
                                        <?php if(form_error('branchName') != ''){?>
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">First Name</label>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group has-error">
                                        <?php }?>
                                            <input type="text" name="firstName" placeholder="First Name" value="<?php echo $details->first_name;?>" class="form-control"> 
                                        <?php if(form_error('firstName') != ''){?>
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Last Name</label>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group has-error">
                                        <?php }?>
                                            <input type="text" name="lastName" placeholder="Last Name" value="<?php echo $details->last_name;?>" class="form-control"> 
                                        <?php if(form_error('lastName') != ''){?>
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Username</label>
                                    ...
                                    <?php if(form_error('userName') != ''){?>
                                        <div class="form-group has-error">
                                    <?php }?>
                                            <input type="text" placeholder="Username" name="userName" value="<?php echo $details->username;?>" class="form-control"> 
                                        <?php if(form_error('userName') != ''){?>
                                    ...
                                    <?php }?>
                                        <select name="roleName" class="form-control">
                                            ...
                                            <?php foreach($roles as $role):?>
                                                <option <?php if($details->role_id == $role->role_id){?> selected <?php }?> value="<?php echo $role->role_id;?>"><?php echo ucwords($role->role_name);?></option>
                                            <?php endforeach;?>
                                        </select>
                                    <?php if(form_error('roleName') != ''){?>
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Contact Number</label>
                                    ...
                                    <?php if(form_error('contactNumber') != ''){?>
                                        <div class="form-group has-error">
                                    <?php }?>
                                        <input type="text" name="contactNumber" value="<?php echo $details->contact_no;?>" placeholder="Contact Number" class="form-control"> 
                                       <?php if(form_error('contactNumber') != ''){?>
