<div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                        ...
                        <?php //echo"<pre>";print_r($branch_name);exit;?>
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="<?php echo base_url('branch/users/add');?>" enctype="multipart/form-data">
                                        ...
                                        <?php }?>
                                            <select required="" name="branchName" class="chosen-select form-control">
                                                ...
                                                <?php foreach($branches as $branch):?>
                                                    <option <?php if($branch_name == $branch->branch_id){?> selected <?php }?> value="<?php echo $branch->branch_id;?>"><?php echo $branch->branch_name;?></option>
                                                <?php endforeach;?>
                                            </select> 
                                        <?php if(form_error('branchName') != ''){?>
