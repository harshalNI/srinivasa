                        ...
                        <div class="row" id="container">
                            <div class="col-sm-12">
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select required="" name="customerName" <?php if(!empty($record)){?> readonly <?php }?> class="chosen-select"  id="customerName">
                                                ...
                                                <?php foreach($customers as $customer):?>
                                                    <option <?php if(!empty($details)){ if($details[0]->customer_id == $customer->customer_id) {?> selected <?php }}?> value="<?php echo $customer->customer_id;?>"><?php echo $customer->customer_name;?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <label>Advance</label>
                                        <input type="text" name="advanceAmount" id="advance" placeholder="Advance" value="<?php if(!empty($details[0]->advance_amount)){ echo $details[0]->advance_amount; }?>" class="form-control">
                                    </div>
                                    <div class="col-lg-2">
                                        <label>Credit Balance</label>
                                        <input type="text" name="creditBalance" required="" id="creditBalance" value="<?php echo $details[0]->credit_balance;?>" placeholder="Credit Balance" readonly="" class="form-control">
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="col-lg-2" id="payment_mode123">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="col-lg-2">
                                        ...
                                        <input value="<?php if(!empty($details[0]->work_site)){ echo $details[0]->work_site; }?>" type="text" name="workSite" placeholder="Work Site" class="form-control">
                                    </div>
                                    <div class="col-lg-2">
                                        <label>Vehicle Number</label>
                                        <input type="text" name="vehicleNumber" placeholder="Vehicle Number" value="<?php if(!empty($details[0]->vehicle_no)){ echo $details[0]->vehicle_no; }?>" class="form-control">
                                    </div>
                            ...
                            <?php foreach($purchase_records as $data)://echo"<pre>";print_r($data);exit;?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="col-lg-2">
                                            ...
                                            <select name="categoryName[]" class="form-control" required="" id="category">
                                                ...
                                                <?php foreach($categories as $category):?>
                                                    <option <?php if($data->category_id == $category->category_id){?> selected <?php }?> value="<?php echo $category->category_id;?>"><?php echo ucwords($category->category_name);?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                        <div class="col-lg-2">
                                            ...
                                            <select name="productName[]" class="form-control" required="" id="product">
                                                ...
                                                <?php foreach($products as $product):?>
                                                    <option <?php if($data->prod_id == $product->product_id){?> selected <?php }?> value="<?php echo $product->product_id;?>"><?php echo $product->product_name;?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                        <div class="col-lg-2">
                                            <label>Quantity</label> 
                                            <input value="<?php echo $data->quantity;?>" type="text" name="productQuantity[]" id="quantity" class="form-control quantity">
                                        </div>
                                        <div class="col-lg-2">
                                            <label>Rate</label> 
                                            <input type="text" value="" name="ratePerItem[]" id="ratePerItem" class="form-control ratePerItem">
                                        </div>
                                        <div class="col-lg-2">
                                            <label>Total</label> 
                                            <input type="text" value="<?php echo $data->rate;?>" name="productRate[]" id="rate" placeholder="Rate" readonly="" class="form-control rate">
                                        </div>
