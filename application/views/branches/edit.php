            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="<?php echo base_url('branches/edit/'.$details->branch_id);?>" enctype="multipart/form-data">
                                <div class="form-group"><label class="col-lg-2 control-label">Branch Name</label>
                                    <div class="col-lg-6">
                                        <?php if(form_error('branchName') != ''){?>
                                        <div class="form-group has-error">
                                        <?php }?>
                                            <input type="text" name="branchName" placeholder="Branch Name" value="<?php echo $details->branch_name;?>" class="form-control"> 
                                        <?php if(form_error('branchName') != ''){?>
